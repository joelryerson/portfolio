...
const limitsMd = [
  ...
  `- Asteri: the consolidated token foundation reached production on a limited set of pilot dashboard surfaces (roughly seven files, no intended visual change); engineering continued the broader rollout; the homepage migration remained under review when Joel's engagement ended (status not yet documented in the public case study).`,
  `- StartupOS: dates to 2022 (approved). Joel's exact formal job title there is not publicly verified; the portfolio describes the work, not a title.`,
